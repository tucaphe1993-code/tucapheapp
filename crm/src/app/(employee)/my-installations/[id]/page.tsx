...
export default async function MyInstallationDetailPage({
  params,
}: PageProps<"/my-installations/[id]">) {
  ...
  if (session!.user.role === "EMPLOYEE" && installation.technician_id !== session!.user.id) notFound();
